...
import com.sofka.cardgame.events.CartaRetiradaDeMazo;
import com.sofka.cardgame.events.CartasAsignadasAGanador;
...
public class MazoMaterializeHandle {
    ...
    @EventListener
    public void handleCartaQuitadaDelMazo(CartaRetiradaDeMazo event){
    ...
    @EventListener
    public void handleCartasAsignadasAJugador(CartasAsignadasAGanador event){
