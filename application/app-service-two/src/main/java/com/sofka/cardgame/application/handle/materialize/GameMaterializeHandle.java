...
public class GameMaterializeHandle {
    ...
    public void handleJuegoCreado(JuegoCreado event) {
        ...
        data.put("uid", event.getJugadorPrincipalId().value());
    ...
    public void handleJugadorAgregado(JugadorAgregado event) {
        ...
        data.set("jugadores."+event.getIdentity() .value()+".alias", event.getAlias());
        data.set("jugadores."+event.getIdentity().value()+".jugadorId", event.getIdentity().value());
